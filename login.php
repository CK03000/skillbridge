...
if ($isPasswordCorrect) {
    if ($role === 'user') {
        echo json_encode(array('success' => true, 'message' => 'Login successful', 'username' => $username));
    } else {
        echo json_encode(array('success' => false, 'message' => 'Only users with role "user" can log in.'));
    }
} else {
